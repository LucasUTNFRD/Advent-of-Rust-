...
fn main() {
    let data = read_to_string("inputs/year2025/day07.txt").unwrap();

    let input = year2025::day07::parse(&data);

    let start = Instant::now();
    let solution_part_1 = year2025::day07::part_1(&input);
    ...
    let start = Instant::now();
    let solution_part_2 = year2025::day07::part_2(&input);
